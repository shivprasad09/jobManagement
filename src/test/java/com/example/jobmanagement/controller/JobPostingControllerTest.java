...
class JobPostingControllerTest {
    ...
    void testCreateJobPosting() {
        // Arrange
        JobPosting newJob = new JobPosting((Long) null, "New Job", "Job description");
    ...
    void testUpdateJobPosting() {
        ...
        JobPosting updatedDetails = new JobPosting(1L, "New Title", "New Description");
        JobPosting updatedJob = new JobPosting(1L, "New Title", "New Description");

        when(jobPostingService.updateJobPosting(anyLong(), any())).thenReturn(updatedDetails);

        // Act
        JobPosting result = jobPostingController.updateJobPosting(1L, updatedJob);
